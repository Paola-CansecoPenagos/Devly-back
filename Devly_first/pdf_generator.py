...
def generar_pdf(table_frecuency_campo2,table_frecuency_campo1,table_frecuency_campo3,
    ...
    x_pos = 70
    y_pos -= 40  # Espacio adicional antes de la desviación media
    c.drawString(70, 600, "Datos ordenados de Temperatura:")
    ...
    x_pos = 70
    y_pos -= 40  # Espacio adicional antes de la desviación media
    c.drawString(70, 580, "Datos ordenados de Temperatura del agua:")
    ...
    x_pos = 70
    y_pos -= 40  # Espacio adicional antes de la desviación media
    c.drawString(70, 600, "Datos ordenados de Conductividad del agua:")
